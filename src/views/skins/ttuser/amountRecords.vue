...
<!--      </el-form-item>-->
      ...
      <el-form-item label="变动场景">
        <el-select v-model="queryParams.source" placeholder="请选择变动场景" clearable>
          <el-option
            v-for="dict in dict.type.user_amount_records"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table :data="tableData" style="width: 100%" v-loading="loading">
      <el-table-column align="center" prop="id" label="金币流水记录ID"></el-table-column>
      <el-table-column align="center" prop="userId" label="用户ID	"></el-table-column>
      <el-table-column align="center" prop="amount" label="变动金额	"></el-table-column>
      <el-table-column align="center" prop="finalAmount" label="最终金额	"></el-table-column>
      <el-table-column align="center" prop="type" label="变动类型">
        <template slot-scope="scope">
          <div v-if="scope.row.type==0" class="df">
            <span class="ds" style="background-color:#00a65a;"></span>支出
          </div>
          <div v-if="scope.row.type==1" class="df">
            <span class="ds" style="background-color:#f3c192;"></span>收入
          </div>
        </template>
      </el-table-column>
